    ...
    <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50 py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-[32px] sm:text-[40px] md:text-[48px] font-bold tracking-tight text-[#343A40]" suppressHydrationWarning>
            {t('hero.title')}
          </h1>
          <p className="mt-6 text-lg sm:text-xl leading-8 text-[#6C757D]" suppressHydrationWarning>
            {t('hero.subtitle')}
          </p>
          <p className="mt-4 text-base text-[#ADB5BD]" suppressHydrationWarning>
            {t('hero.description')}
          </p>
